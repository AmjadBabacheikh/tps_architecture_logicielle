 ...
 * For example, each com.company.tp.elevator can be at a different level, and can be going up,
 * or down.
 * </p>
 *
 * The objective of this exercise is to write a program that will identify which
 * com.company.tp.elevator will be served once a request for an com.company.tp.elevator is registered.
 * </p>
 *
 * Please note these rules : </br>
 * - An com.company.tp.elevator is requested by default from <b>top</b> floor. </br>
 * - An com.company.tp.elevator can be resting at a given floor, going up or going down. </br>
 * - An com.company.tp.elevator switch automatically his direction when reaching the edges of
 * the building (means the first and top floors). </br>
 * - An com.company.tp.elevator can not switch his direction in the middle of a building.
 * Example: in a building of 10 floors, an com.company.tp.elevator at the 3rd floor and
 * ascending can never go down before reaching the 10th floor. And vice
 * versa.</br>
 * - An com.company.tp.elevator is never in between floors.
 *
 * @author SQLi
 */
public class ElevatorTest {
    ...
    public void elevators_going_down_arrive_last_to_top_floor() {
        ...
        building.move("id2", "DOWN"); // tell the com.company.tp.elevator "id2" to move "DOWN".
    ...
    public void elevators_going_up_and_not_stopping_should_arrive_first_to_top_floor() {
        ...
        building.stopAt("id3", 7); // request com.company.tp.elevator "id3" to stop at level 7
        String idOfFirstAvailableElevator = building.requestElevator();
        assertEquals("id1", idOfFirstAvailableElevator);
    }
    ...
    public void can_request_elevator_in_middle_of_building() {
        ...
        assertEquals("id2", idOfFirstAvailableElevator); // "id2" is the closest com.company.tp.elevator to 5th floor
    }
}
