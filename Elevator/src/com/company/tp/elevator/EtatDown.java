...
public class EtatDown extends Etat {
    ...
    @Override
    public void down() {
        throw new IllegalArgumentException("the com.company.tp.elevator is already in down state");
    }

    @Override
    public void up() {
        throw new IllegalArgumentException("the com.company.tp.elevator cannot switch to up state");
    }
