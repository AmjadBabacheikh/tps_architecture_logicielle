...
public class EtatUp extends Etat{
    ...
    @Override
    public void down() {
        throw new IllegalStateException("com.company.tp.elevator is going up it can't switch direction ...");
    }

    @Override
    public void up() {
        throw new IllegalArgumentException("the com.company.tp.elevator is already in up state");
    }
